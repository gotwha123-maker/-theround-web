...
const mockDesigners = [
  ...
  },
  {
    ...
    isHidden: false,
    img: "assets/김강우.jpg",
    ko: { name: "김강우", tag: "방송인·작가", slogan: '"기록으로 남북의 마음을 잇는 디자이너"', specialty: "북한 실상 증언 / 도서 집필 / 사회 활동", bio: "북한 내부의 생생한 경험을 바탕으로, 우리가 몰랐던 북한의 진실을 글과 목소리로 전합니다. 최근 저서를 통해 남북 청년들에게 희망의 메시지를 전달하고 있습니다.", career: "• 저서 《김강우의 여정》 (가칭) 집필 및 발간\n• 채널A \"이제 만나러 갑니다\" 정규 출연\n• 북한 인권 개선 캠페인 및 활동가\n• 공공기관/학교 대상 통일 안보 강사" }
  },
  {
    id: "des-8",
    isHidden: true,
