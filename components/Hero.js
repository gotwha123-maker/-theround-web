...
export default function Hero() {
  return (
    <>
      <section className="hero-split-section min-h-[100svh] flex items-center justify-center bg-[var(--color-bg-dark)] relative py-24 px-4 overflow-hidden sm:px-6 md:min-h-screen md:py-28 lg:py-32 lg:px-8">
        ...
        <div className="hero-split-container max-w-6xl w-full grid grid-cols-1 gap-10 items-center relative z-20 text-center sm:gap-12 md:grid-cols-[1.10fr_1.15fr] md:gap-16 md:text-left lg:gap-20">
          {/* Left Side: Content */}
